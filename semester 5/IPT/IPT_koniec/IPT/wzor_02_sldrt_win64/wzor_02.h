...
#ifndef RTW_HEADER_wzor_02_h_
#define RTW_HEADER_wzor_02_h_
#include <string.h>
#include <stddef.h>
#ifndef wzor_02_COMMON_INCLUDES_
# define wzor_02_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* wzor_02_COMMON_INCLUDES_ */

#include "wzor_02_types.h"
...
#define wzor_02_rtModel                RT_MODEL_wzor_02_T
...
typedef struct {
  ...
  real_T Zbiornik_1;                   /* '<S1>/Sum5' */
  real_T Zbiornik_2;                   /* '<S1>/Sum6' */
  real_T Zbiornik_3;                   /* '<S1>/Sum7' */
...
#define rtB                            wzor_02_B
#define BlockIO                        B_wzor_02_T
#define rtP                            wzor_02_P
#define Parameters                     P_wzor_02_T
#define rtDWork                        wzor_02_DW
#define D_Work                         DW_wzor_02_T
...
extern P_wzor_02_T wzor_02_P;

/* Block signals (auto storage) */
extern B_wzor_02_T wzor_02_B;

/* Block states (auto storage) */
extern DW_wzor_02_T wzor_02_DW;

/* Model entry point functions */
extern void wzor_02_initialize(void);
extern void wzor_02_output(void);
extern void wzor_02_update(void);
extern void wzor_02_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern wzor_02_rtModel *wzor_02(void);
...
extern RT_MODEL_wzor_02_T *const wzor_02_M;
 ...
 * Block '<S1>/Tank 1 Bias' : Unused code path elimination
 * Block '<S1>/Tank 2 Bias' : Unused code path elimination
 * Block '<S1>/Tank 3 Bias' : Unused code path elimination
 ...
 * '<Root>' : 'wzor_02'
 * '<S1>'   : 'wzor_02/Tank3'
 * '<S2>'   : 'wzor_02/Tank3/RT-DAC Frequencies'
 * '<S3>'   : 'wzor_02/Tank3/RT-DAC Safety Alert'
 * '<S4>'   : 'wzor_02/Tank3/RT-DAC PCI PWM Pump'
 * '<S5>'   : 'wzor_02/Tank3/RT-DAC PCI PWM Valve 1'
 * '<S6>'   : 'wzor_02/Tank3/RT-DAC PCI PWM Valve 2'
 * '<S7>'   : 'wzor_02/Tank3/RT-DAC PCI PWM Valve 3'
 * '<S8>'   : 'wzor_02/Tank3/RT-DAC PCI PWM Valve 4'
 * '<S9>'   : 'wzor_02/Tank3/RT-DAC PCI PWM Valve 5'
 */
#endif                                 /* RTW_HEADER_wzor_02_h_ */

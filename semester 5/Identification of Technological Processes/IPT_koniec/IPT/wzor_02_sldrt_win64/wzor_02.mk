...
MODEL                := wzor_02
MODULES              := rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c wzor_02_data.c 
MAKEFILE             := wzor_02.mk
MATLAB_ROOT          := C:/PROGRA~1/MATLAB/R2015A~1
MATLAB_BIN           := C:/PROGRA~1/MATLAB/R2015A~1/bin
S_FUNCTIONS          := tank_safetyalert.c tank_frequencies.c tank_pwm.c
S_FUNCTIONS_LIB      := 
SOLVER               := 
NUMST                := 1
TID01EQ              := 0
...
#
MODELLIB                  := wzor_02lib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := wzor_02_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;E:/identyfikacja_2022/sroda_11_45/wzor_02_sldrt_win64;E:/identyfikacja_2022/sroda_11_45;E:/identyfikacja_2022/sroda_13_15;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
%.obj : $(MATLAB_ROOT)/toolbox/MultiTank/DevDriv/%.c $(MAKEFILE)
	$(call BUILDOBJ, $(CC))
...
%.obj : $(MATLAB_ROOT)/toolbox/MultiTank/DevDriv/%.cpp $(MAKEFILE)
	$(call BUILDOBJ, $(CPP))

...
Wykorzystaj w tym przypadku wywołanie super().



Następnie utwórz po jednej instancji klas odpowiednio:
...
W odpowiedzi wydrukuj wartość atrybutu __dict__ instancji vehicle oraz car do konsoli.

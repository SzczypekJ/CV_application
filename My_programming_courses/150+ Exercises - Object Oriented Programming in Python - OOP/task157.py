"""Podana jest implementacja klas: Product oraz Warehouse. Do klasy Warehouse dodaj metodę o nazwie display_products() pozwalającą wyświetlić wszystkie produkty znajdujące się w atrybucie products klasy Warehouse.
...
W odpowiedzi wywołaj metodę display_products() na instancji warehouse.

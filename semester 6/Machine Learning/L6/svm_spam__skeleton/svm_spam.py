...
clf = svm.SVC(C = 0.1, kernel="linear", random_state=1, probability=True)
...
vocabulary_dict = get_vocabulary_dict('data/vocab.txt')
...
path3 = 'data/emailSample1.txt'
path4 = 'data/emailSample2.txt'
path5 = 'data/mySpam.txt'
path6 = 'data/mySpam2.txt'
path7 = 'data/mySpam3.txt'

# Read and predict
def read_and_predict(filename):
...
read_and_predict(path)
input('\nNext trial. Press enter to continue.\n')
read_and_predict(path2)
input('\nNext trial. Press enter to continue.\n')
read_and_predict(path3)
input('\nNext trial. Press enter to continue.\n')
read_and_predict(path4)
input('\nNext trial. Press enter to continue.\n')
read_and_predict(path5)
input('\nNext trial. Press enter to continue.\n')
read_and_predict(path6)
input('\nNext trial. Press enter to continue.\n')
read_and_predict(path7)